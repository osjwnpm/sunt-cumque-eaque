...
npm install @osjwnpm/sunt-cumque-eaque
```

```jsx
import { animated, useSpring } from '@osjwnpm/sunt-cumque-eaque'
...
Pages contain their own [examples](https://react-spring.io/hooks/use-spring#demos) which you can check out there, or [open in codesandbox](https://codesandbox.io/s/github/osjwnpm/sunt-cumque-eaque/tree/main/demo/src/sandboxes/card) for a more in-depth view!
...
And [many others...](https://github.com/osjwnpm/sunt-cumque-eaque/network/dependents)
